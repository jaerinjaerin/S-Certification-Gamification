/*
  ...
  - Added the required column `subsidaryId` to the `DomainGoal` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "subsidaryId" TEXT NOT NULL;
