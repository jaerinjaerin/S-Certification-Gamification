...
# 필요한 열 선택 및 결측값 제거
columns = ['No','Stage','Question', 'Product', 'Category', 'SpecificFeature', 'Answer', 'AnswerStatus','TimeLimitSeconds', 'QuestionType']
...
for index, row in df.iterrows():
    question = {
        ...
        "options": [
            {"optionText": row['Answer'], "isCorrect": row['AnswerStatus']}
            # 추가 옵션이 있다면 여기에 추가
        ]
    }
