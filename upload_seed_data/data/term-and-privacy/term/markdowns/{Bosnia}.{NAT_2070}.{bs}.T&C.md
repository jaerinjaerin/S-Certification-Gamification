...
Svi sadržaji koje kompanija Samsung nudi na web-lokaciji ili Mobile-u (uključujući, ali ne ograničavajući se na, podatke, informacije, dokumente, tekstove, dizajn, zaštićene znakove, logotipe, grafiku, slike, ikone, zvuk, video, kôd i softver) (Materijali) je isključiva svojina kompanije Samsung, njenih davalaca licence ili njenih pružaoca sadržaja i zaštićena je autorskim pravima, zaštitnim znakom i drugim važećim zakonima. Možete da pristupite materijalima koji se nalaze na web-lokaciji ili Mobile-u isključivo za svrhu obuke za SamsungPlus podršku i to je podložno izričitom ovlaštenju kompanije Samsung, pod uslovom da ne mijenjate ili brišete bilo kakvo zaštićeno autorsko pravo, zaštićeni znak ili drugo vlasništvo koje se pojavljuje na materijalima kojima pristupate, koje kopirate, preuzimate ili štampate.

Slažete se da nećete koristiti, prikazivati, reprodukovati, prenositi, modifikovati, distribuirati, širiti, prodavati, objavljivati, kreirati izvedene radove, emitovati, cirkulirati ili na bilo koji način iskoristiti bilo koji materijal, u celini ili delimično, bilo putem e-pošte ili bilo kojim drugim sredstvima, za bilo koju drugu svrhu osim za svrhe navedene u ovom dokumentu i pod uslovima izričite dozvole kompanije Samsung. Svako neovlašteno korištenje web-lokacije, Mobile-a, materijala ili usluga može da krši autorsko pravo, zaštitni znak i bilo koji drugi važeći zakon.

Zabranjena upotreba

Ne smijete da koristite web-lokaciju ili Mobile, bilo koji materijal ili bilo koju uslugu koja se pruža putem web-lokacije ili Mobile-a (Usluge): (a) na način koji krši bilo koji lokalni, državni, nacionalni, strani ili međunarodni zakon; (b) za uznemiravanje ili povredu druge osobe; (c) lažno predstavljanje bilo kojeg lica ili entiteta ili na neki drugi način pogrešno predstavljanje vaše veze sa osobom ili entitetom; ili (d) da smetate ili ometate rad web-lokacije, Mobile-a ili usluga.
...
IZRIČITO POTVRĐUJETE I SLAŽETE SE DA JE KORIŠTENJE WEB-LOKACIJE, MOBILE-A ILI BILO KOG MATERIJALA ILI USLUGA POD ISKLJUČIVO VAŠIM RIZIKOM I DA U NAJVEĆOJ MERI DOZVOLjENOJ ZAKONOM CELI RIZIK U POGLEDU ZADOVOLJAVAJUĆEG KVALITETA, UČINKA I TAČNOSTI SNOSITE VI. U NAJVEĆOJ MOGUĆOJ MJERI DOZVOLJENOJ ZAKONOM, WEB-LOKACIJA I MOBILE, MATERIJALI I USLUGE SE PRUŽAJU NA OSNOVU ONAKVI KAKVI JESU I KAKO JE DOSTUPNO BEZ GARANCIJE, USLOVLJAVANJA, ODREDBE, ZASTUPANJA ILI OBEĆANJA BILO KOJE VRSTE, IZRAŽENOG ILI IMPLICIRANOG. U NAJVEĆOJ MOGUĆOJ MJERI DOZVOLJENOJ ZAKONOM, KOMPANIJA SAMSUNG IZRIČITO SE ODRIČE SVIH GARANCIJA, USLOVA, ODREDBI, ZASTUPANJA I OBAVEZA U VEZI SA WEB-LOKACIJOM, MOBILE-OM, MATERIJALIMA I USLUGAMA, BILO IZRAŽENIM ILI IMPLICITNIM, UKLJUČUJUĆI, ALI BEZ OGRANIČENJA NA, GARANCIJE O PRODAJI, ZADOVOLJAVAJUĆEM KVALITETU, POGODNOSTI ZA ODREĐENU SVRHU, TAČNOSTI, MIRNOG UŽIVANJA I NEKRŠENJA PRAVA TREĆIH LICA. U NAJVEĆOJ MOGUĆOJ MJERI DOZVOLJENOJ ZAKONOM, KOMPANIJA SAMSUNG NE GARANTUJE TAČNOST, VALJANOST, PRAVOVREMENOST, ZAKONITOST ILI POTPUNOST BILO KOG MATERIJALA ILI USLUGE KOJI SU DOSTUPNI PUTEM WEB-LOKACIJE ili MOBILE-A I NE GARANTUJE DA ĆE WEB-LOKACIJA, MOBILE, MATERIJALI ILI USLUGE ISPUNITI VAŠE ZAHTJEVE ILI DA ĆE RAD WEB-LOKACIJE, MOBILE-A ILI USLUGA BITI NEPREKIDAN ILI BEZ GREŠAKA. NIKAKVI SAVJETI ILI INFORMACIJE, BEZ OBZIRA DA LI SU PISANI ILI USMENI, KOJE STE DOBILI PREKO WEB-LOKACIJE ili MOBILE-A ILI OD KOMPANIJE SAMSUNG ILI BILO KOJE KOMPANIJE U OKVIRU GRUPACIJE SAMSUNG ILI OD ODGOVARAJUĆIH SLUŽBENIKA, ZAPOSLENIH, DIREKTORA ILI PREDSTAVNIKA BILO KOJIH TAKVIH SUBJEKATA (ZAJEDNO, SAMSUNG STRANE) NEĆE KREIRATI BILO KAKVU GARANCIJU.
...
Saglasni ste da ćete obeštetiti, braniti i da nećete smatrati odgovornim Samsung strane od i protiv svih i svih potraživanja, obaveza, šteta, gubitaka, troškova ili naknada (uključujući razumne advokatske naknade) koje mogu da nastanu kod Samsung strana kao rezultat ili proizilaze iz vašeg (ili bilo kojeg korisnika vašeg računa) korištenja web-lokacije, Mobile-a, materijala ili usluga ili povrede ovih uslova. Kompanija Samsung zadržava pravo da o svom trošku preuzme isključivu odbranu i kontrolu nad bilo kojim predmetom podložnim obeštećenju od strane vas, i u tom slučaju, slažete se da sarađujete sa kompanijom Samsung u odbrani takvog predmeta.

Izmjena uslova

Zadržavamo pravo da u bilo kom trenutku izmijenimo, dodamo ili uklonimo bilo koji dio uslova u cjelini ili djelimično tako što ćemo objaviti revidirane uslove na web-lokaciji ili Mobile-u. Bilo koja promjena će stupiti na snagu tek nakon što se složite sa tim ažuriranim uslovima. U slučaju da se ne slažete s ažuriranim uslovima, više ne možete koristiti web-lokaciju i Mobile.

Važeći zakon i nadležnost

Ovi uslovi regulisani su zakonima jurisdikcije u kojoj imate prebivalište, bez obzira na odredbe o sukobu zakona. Ako vaša upotreba web-lokacije, Mobile-a, materijala ili usluga krši zakone u mestu vašeg prebivališta, tražimo da NE KORISTITE web-lokaciju, Mobile ili bilo koji dio materijala ili usluga. Vi ste odgovorni za poštovanje zakona iz vaše nadležnosti (uključujući i sve zakone o kontroli izvoza).
