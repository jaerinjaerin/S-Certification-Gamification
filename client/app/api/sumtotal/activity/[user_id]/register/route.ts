    ...
    for (let attempt = 0; attempt < 2; attempt++) {
      try {
        const response = await fetch(
          ...
          // `https://samsung.sumtotal.host/apis/api/v1/users/${userId}/activities/${activityId}/register`,
          `https://samsung.sumtotal.host/apis/api/v2/users/${userId}/activities/${activityId}/register`,
          {
            method: "PUT",
            cache: "no-store",
            headers: {
