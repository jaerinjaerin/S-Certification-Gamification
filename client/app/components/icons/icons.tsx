  ...
  return (
    <svg width="19" height="13" viewBox="0 0 19 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={forwardRef}>
      <path
        ...
        fill="white"
      />
      <path d="M16.3639 3.45056V5.54191H18.8379V7.45568H16.3725V9.58617H14.141V7.46987H11.6278V5.55414H14.1249V3.45056H16.3639Z" fill="white" />
    </svg>
  );
});
...
export const StarIcon = React.forwardRef<SVGSVGElement, IconProps>(({ color, ...props }, forwardRef) => {
  return (
    <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={forwardRef}>
      <path
