...
export const QuestionMark = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardRef) => {
    return (
      <svg
        width="10"
...
export const BluePaperAirplaneIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardRef) => {
    return (
      <svg
        width="50"
...
export const SPlusIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardRef) => {
    return (
      <svg
        width="19"
